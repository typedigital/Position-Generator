...
import { generateEmailHtml, sendEmail, type EmailData } from './emailService.js';
...
export async function processIssue(issueData: ProcessedIssue): Promise<ProcessedIssue> {
